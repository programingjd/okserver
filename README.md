![jcenter](https://img.shields.io/badge/_jcenter_-_3.4.2-1-6688ff.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Tests_-_22/22-green.png?style=flat)
# okserver
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/ok/server/okserver/3.4.2-1/okserver-3.4.2-1.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.ok.server:okserver:3.4.2-1'
}
```
